...
void draw() {
    ...
    drawText( (width / 2) - 10, height - 15,
             "GamerLeft "+ int2str(score_left) + " : " + int2str(score_right) + " GamerRight"); 

	if(score_right == 5){ cout << "Game Over - Winner GamerRight"; getchar(); }
	if(score_left == 5){  cout << "Game Over - Winner GamerLeft"; getchar(); } 
...
int _tmain(int argc, char** argv) {
    ...
    glutCreateWindow("The Project of PingPong2D ");
